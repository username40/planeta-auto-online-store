<template>
    <div class="radio-overlay">
        ...
        <label :for="this.identifier" class="Body-18"><slot/></label>
    </div>
</template>

<script>
export default {
    props: ['identifier', 'checked', 'disabled', 'name']
}
</script>
...
<style scoped>
    ...
    .radio:focus + label:before {
        -webkit-box-shadow: 0 0 0 1px var(--blueberry);
    ...
    .disabled {
        border: 1px solid #8d9aae!important;
